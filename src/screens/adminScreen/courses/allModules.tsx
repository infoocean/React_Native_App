...
const AllModuleScreen = ({ navigation }: any) => {
    const data = [
                    ...
                    renderItem={({ item }) => {
                        return (
                            <View style={styles.Modulebox}>
                                <Image style={styles.modimage} source={{ uri: item.image }} />
                                <View style={styles.ModboxContent}>
                                    <Text style={styles.Modtitle}>Shubham Kumar Jaiswal
                                    </Text>
                                    <Text style={styles.modCoursename}>Course : React Js</Text>
                                    <Text style={styles.modSessions}>No.of Sessions : 200</Text>
...
export default AllModuleScreen;
